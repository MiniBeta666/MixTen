...
Pattanadech Saroj (Tar)

Kollawat Janchaiyaphum (Teng)

Best regards,
SPDM Team & DPark Team]];
AZY["9"]["Name"] = [[Text]];
...
AZY["96"]["Text"] = [[UI,Dev,Scripting Module]];
AZY["96"]["Name"] = [[Desc]];
...
AZY["9c"]["Text"] = [[Gui Convert & ChatGPT Premium]];
AZY["9c"]["Name"] = [[Desc]];
...
AZY["a2"]["Text"] = [[Hosting & Executor TextBox]];
AZY["a2"]["Name"] = [[Desc]];
...
local Window = Rayfield:CreateWindow({
   Name = "Dev Hub Key System",
   LoadingTitle = "Dev Hub",
   LoadingSubtitle = "Ui by siruis, Rayfield Ui",
   ConfigurationSaving = {
      Enabled = true,
      FolderName = Keyyy, 
      FileName = "DevKey.txt"
   ...
   KeySystem = true, 
   KeySettings = {
      Title = "Dev Hub Key System",
      Subtitle = "",
      Note = "get key form https://devhub.gitpage.com",
      FileName = "DevKey",
      SaveKey = false,
